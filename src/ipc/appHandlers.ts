...
ipcMain.handle(
  "set-editor-color",
  (_event, appName: string, color: string, userId: number) => {
...
ipcMain.handle(
  "get-accent-color",
  (_event, theme: "dark" | "light", userId: number) => {
...
ipcMain.handle(
  "set-accent-color",
  (_event, color: string, theme: "dark" | "light", userId: number) => {
...
ipcMain.handle(
  "set-user-theme",
  (_event, theme: "light" | "dark", userId: number) => {
